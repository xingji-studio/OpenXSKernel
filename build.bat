...
mkdir out
mkdir esp\EFI\BOOT
..\tools\mingw64\bin\x86_64-w64-mingw32-gcc.exe -W -Wno-missing-field-initializer -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-unused-variable -Wextra -e efi_main -nostdinc -nostdlib -fno-builtin -Wl,--subsystem,10 -o out\BOOTX64.efi bootx64.c
